...
| `orders_marketing_logistics_de.csv` | Dataset (120 řádků): objednávky, marketing (ROAS/CPA), náklady na produkty a dopravu, delivery_time_days, vratky, marže |
